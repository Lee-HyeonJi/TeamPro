		...
		<section id="services" class="section" style="padding-top:200px ; height: 400px ;background-image: url('<c:url value="/resources/img/background/doghug.jpg"/>');">
	      <div class="container" >
	        <div class="section-header">          
	          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">돌보미 <span>대리산책</span></h2>
	          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
	          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">대리산책 리스트</p>
	        </div>
	      </div>
	    </section>
	    <div class="page-title" style="background-color: #f5efb4; text-align: center;">
	    	<a href="<c:url value="/Care/TrainerInfo.do"/>">돌보미 정보</a>
	    	<a class="on" href="<c:url value="/Care/TrainerMain.do"/>"> 대리산책</a>
      		...
      		<div class="container">
		      	<div class="row">
					...
					<div class="col-md-6" style="text-align: right;">
						<form class="form-inline" method="post" action="<c:url value="/Care/TrainerMain.do"/>">
							<div class="form-group">
								<input type="hidden" value="like" name="searchBy">
								<button type="submit">좋아요한 공고</button>
							</div>​
						</form>
						<form class="form-inline" method="post" action="<c:url value="/Care/TrainerMain.do"/>">
							<div class="form-group">
								<input type="text" name="searchWord" class="form-control" style="color: black;" placeholder="주소 검색" />
		        ...
		        <div class="row">
					...
					<c:if test="${not isEmpty }">
						<c:forEach items="${listPagingData.lists }" var="item" varStatus="loop">
							<c:if test="${item.care_state == state}">
