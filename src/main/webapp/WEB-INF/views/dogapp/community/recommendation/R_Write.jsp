...
<html>
  <head>
    ...
    <style>
	   ...
	   #map {margin-top: 10px;}
	   label {margin:3px; text-align: center;}
	</style>
  </head>
  <body>
    ...
    <div class="page-title" style="background-color: #f5efb4; text-align: center;">
     ...
     <section id="blog" class="section">
      ...
      <div class="container">
		...
		<div class="row">
		<div class="col-md-12">
			<form method="post" action="<c:url value='/Community/Recommendation/R_Write.do'/>" method="post" id="frm" enctype="multipart/form-data">	
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<input type="file" name="r_images" id="real-input" multiple="multiple" accept="image/gif, image/jpeg, image/png" style="display: none;">
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<input style="color: black;" type="text" class="form-control" name="r_title" placeholder="제목을 입력하세요?">
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<textarea class="col-sm-8" style="color: black; margin:10px; width: 100%;" rows="5" class="form-control " name="r_content" placeholder="추천이유를 입력하세요"></textarea>
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
				...
				<input type="hidden" id="testtext" name="r_clickLineL" ><!--  데이터 넘기기!!-->
				<input type="hidden" id="testtext2" name="r_clickLineP" >
				<input type="hidden" id="testtext3" name="r_clickLineA" >
