  ...
  <body>
    ...
    <div class="page-title" style="background-color: #f5efb4; text-align: center;">
     ...
     <div class="container">
		...
		<div class="row">
		<div class="col-md-12">
			<form method="post" action="<c:url value='/Community/Photo/P_EditProcess.do'/>" method="post" id="frm" enctype="multipart/form-data">
				<input type="hidden" name="p_no" value="${record.p_no}"/>
				<input type="hidden" name="originImages" value="${record.p_images}"/>
				<div id="imagePreview" >
				...
				<input type="file" name="p_images" id="real-input" multiple="multiple">
				<div class="form-group">
					<label class="col-sm-2 control-label">제목</label>
					<div class="col-sm-4">
						<input style="color: black;" type="text" class="form-control" name="p_title" placeholder="제목을 입력하세요?" value="${record.p_title}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-8">
								<textarea style="color: black;" rows="5" class="form-control" name="p_content" placeholder="내용을 입력하세요">${record.p_content }</textarea>
							</div>
						</div>
					</div>
				</div>
