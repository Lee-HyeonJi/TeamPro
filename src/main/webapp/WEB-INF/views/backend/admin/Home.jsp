...
<!--/ Statistics -->
    ...
    <script src="<c:url value="/resources/theme-assets/vendors/js/charts/chartist.min.js"/>" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN CHAMELEON  JS-->
    ...
    <!-- END CHAMELEON  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<c:url value="/resources/theme-assets/js/scripts/pages/dashboard-lite.js"/>" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>